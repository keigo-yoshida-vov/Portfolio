$(function() {
    ...
    $(window).on("load", function() {
        ...
        $('#load6').delay(700).fadeIn("slow");
        $('#load7').delay(750).fadeIn("slow");
        $('#load8').delay(800).fadeIn("slow");
        $('#load9').delay(850).fadeIn("slow");
        $('#load10').delay(900).fadeIn("slow");
        $('#load11').delay(950).fadeIn("slow");
        $('#load12').delay(1000).fadeIn("slow");
        $(".cat").delay(1100).fadeIn("slow");
